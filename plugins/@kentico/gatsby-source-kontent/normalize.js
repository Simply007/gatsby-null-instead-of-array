...
const parseContentItemContents = contentItem => {
  const elements = {};
...
const createKcArtifactNode = (nodeId, kcArtifact, artifactKind, codeName = ``, additionalNodeData = null, includeRawContent = false) => {
...
const addLinkedItemsLinks = (itemNode, linkedNodes, linkPropertyName, sortPattern = []) => {
  ...
  const sortedLinkedNodes = linkedNodes.sort((a, b) => {
